...
<div id="modules" class="container text-center">
  <h3>KENYA FARMERS ADVISORY SYSTEM </h3>
  <h4><span class="label label-success"><?php echo $_SESSION['username']; ?></span>, your advice according to your region <span class="label label-primary"><?php echo $_SESSION['region']; ?></span> is below</h4>
  <br>
  <div class="row">
    <div class="col-sm-6">
    	<div class="page-header">
		 ...
		 <p class="text-center">
		 	<?php 
			    ...
			    $regionsQuery = mysqli_query($connect, "SELECT * FROM regions WHERE region_name ='$region'");
				$fetchRegionFromDb = mysqli_fetch_assoc($regionsQuery);
				echo $fetchRegionFromDb['annual_rainfall']; 
			?>
		 </p>    
    </div>
    <div class="col-sm-6">
		 ...
		 <?php 
			    ...
			    $regionsQuery = mysqli_query($connect, "SELECT * FROM regions WHERE region_name ='$region'");
				$fetchRegionFromDb = mysqli_fetch_assoc($regionsQuery);
				echo $fetchRegionFromDb['farming_systems']; 
			?>		
    </div>    
  </div>  
</div>

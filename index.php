...
<div class="container">				
	<div class="row">
		...
		<div class="col-md-4">			
			<form role="form" id="form1" method="post" action="includes/farmer_login.inc.php">
				<h4 class="text-center margin-title">FARMER LOGIN</h4>				
				<div class="form-group">
					<label for="username"> Username: </label>
					<input type="text" name="username" placeholder="Enter Username" class="form-control" pattern="^[a-z0-9_-]{3,15}$" title="3 to 15 characters with any lower case character, digit or special symbol “_-” only.">
				</div>
				<div class="form-group">
    			...
    			<div class="text-right" style="display: inline;">
      				<a href="agronomist.php">Agronomist</a> 
    			</div>
    			<div class="text-right" style="display: inline;">

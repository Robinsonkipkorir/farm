...
<div id="modules" class="container text-center">
  <h3>ZFC'S FARMING ADVISORY SYSTEM </h3>
  <h4><span style="color: #518e40;"><?php echo $_SESSION['username']; ?></span>, Below you can select symptoms that your plants are showing and we can diagnose the disease for you.</h4>
  <br>
  <div class="page-header">
	...
	<div class="row">
		...
		<div class="col-sm-4">
	    	...
	    	<select class="form-control" id="sel1" name="route" required="required">
	      		<option>-- Disease Symptoms --</option>	      		            
    		</select>
    		<button type="button" class="btn btn-success btn-block" style="margin-top: 28px; float: right;" name="diagnose">Diagnose</button>
    	</div>
		</div>
		<div class="col-sm-8">
		...
		<div class="well text-center">
		     ...
		     if (isset($_POST['diagnose'])) {
		     	...
		     	$symptomsQuery2 = mysqli_query($connect, "SELECT * FROM diseases WHERE symptoms = '$symptoms'");
	        	$symptomsRow2=mysqli_fetch_assoc($symptomsQuery2);
		     ?>				    
			    <p style="font-size: 120%;">Disease Name: <span class="label label-primary"><?php echo $symptomsRow2['disease_name']; ?></span></p>
			    <p style="font-size: 120%;">Symptoms Selected: <span class="label label-warning"><?php echo $symptomsRow2['symptoms']; ?></span></p>
			    <p style="font-size: 120%;">Cause: <span class="label label-danger"><?php echo $symptomsRow2['cause']; ?></span></p>
			    <p style="font-size: 120%;">Solution: <span class="label label-success"><?php echo $symptomsRow2['solution']; ?></span></p>

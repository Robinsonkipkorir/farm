...
<div id="modules" class="container text-center">
  ...
  <h4>Enter your hactares of land you want to use, we will compute the current value as a whole of your land.</h4>
  <br>
  <div class="row">
    <div class="col-sm-6">
    	<form role="form" method="post" action="includes/budgets.inc.php">
    	<div class="form-group">
          <label for="hectares"> Hectares: </label>
          <input type="number" name="hectares" id="hectares" placeholder="Enter Hectares" class="form-control" required="required">
        </div> 
        <button type="submit" class="btn btn-success btn-block" style="margin-top: 28px; float: right;" name="price">Price</button>
        </form>        
    </div>
    <div class="col-sm-6">
     <h3 class="text-center">Present Price: $<?php 
	...
	echo $fetchPriceFromDb['price']; ?> USD/ ha</h3>	

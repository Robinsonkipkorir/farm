...
<div class="container"> 
<H4 class="text-center" style="display: inline;"><b>AGRONOMIST REGISTER</b></h4> 
  <div class="text-left" style="display: inline;">
    (<a href="index.php">Back to Login</a>)
    (<a href="register.php">Farmer Register</a>) 
  </div>
    <div class="row">
    <form role="form" action="includes/agronomist_register.inc.php" method="post">
    <div class="col-sm-6">        

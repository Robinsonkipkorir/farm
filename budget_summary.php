  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	    <ul class="nav navbar-nav">
	      ...
	      <li class="active1"><a href="budgets.php">Budget</a></li>
...
<div id="modules" class="container text-center">
  ...
  <h4>Below is a summary of <?php echo $_SESSION['username']; ?>'s Budget basing on hactares to be used.</h4>
  <br>
  <div class="page-header">
		<h3>Budget Summary</h3>      
	</div>
  <div class="well text-center">
  	<h4>Username: <span class="label label-success"><?php echo $_SESSION['username']; ?></span></>
  	<h4>Hectares: <span class="label label-success"><?php echo $_SESSION['hectares']; ?> ha</span></>
  	<h4>Price: <span class="label label-success">$<?php echo $_SESSION['price']; ?></span></>
  	<h4>Total Amount: <span class="label label-success">$<?php echo $_SESSION['total_amount']; ?></span></>
  	<h4>Date of Budget: <span class="label label-success"><?php echo $_SESSION['date_of_budget']; ?></span></>
  	<h4>Time of Budget: <span class="label label-success"><?php echo $_SESSION['time_of_budget']; ?></span></> 
  </div>  
</div>
